        ...
        <div className="col-md-10">
          <div class="form-left">
            <div className="card">
              ...
              <form>
                <h4>
                  Join our social network for book lovers and let AI do the
                  heavy lifting. Discover your new favorite book based on your
                  interests and connect with others who share your passion.
                </h4>
                ...
                <div className="input-group">
                  <span className="input-group-addon">
                    <i className="glyphicon glyphicon-lock"></i> <FaLock />
                  </span>
                  <input
                    id="password"
                    type="password"
                    className={hasError ? "input-error" : "form-control"}
              ...
              <div className="card-body">
                ...
                {hasError && (
                  <div className="alert alert-danger mt-3">{hasError}</div>
                )}
